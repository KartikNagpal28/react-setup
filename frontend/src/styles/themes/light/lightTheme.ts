...
export const lightColorsTheme: ITheme = {
  ...
  textSiderPrimary: '#9381FF',
  textsidebarSubmenu: '#fff',
  textsidebarSubmenuBackgroundColor: '#9381FF',
  // textSiderSecondary: '#ffffff',
  textSiderSecondary: '#000000',
  siderMenuOptionBackground: '#F8F8F8',
  siderMenuOptionColor: '#000000',
  siderMenuOptionBroder: '#EFEFEF',
  siderBackgroundColor: '#F8F8F8',
  siderLogoTextColor: '#000',
