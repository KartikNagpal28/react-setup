...
const getThemeVariables = (theme: ThemeType) => css`
  ...
  --primary3-color: ${themeObject[theme].primary3};
  ...
  --text-sidebar-sub-menu: ${themeObject[theme].textsidebarSubmenu};
  --text-sidebar-sub-menu-background-color: ${themeObject[theme].textsidebarSubmenuBackgroundColor};
  --text-sider-secondary-color: ${themeObject[theme].textSiderSecondary};
  --sider-Menu-Option-Background: ${themeObject[theme].siderMenuOptionBackground};
  --sider-Menu-Option-Color: ${themeObject[theme].siderMenuOptionColor};
  --sider-Menu-Option-Border: ${themeObject[theme].siderMenuOptionBroder};
  --sider-selected-background-color: ${themeObject[theme].siderBackgroundColor};
  --sider-logo-text-color: ${themeObject[theme].siderLogoTextColor};
