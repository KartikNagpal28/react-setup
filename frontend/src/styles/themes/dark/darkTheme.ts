...
export const darkColorsTheme: ITheme = {
  ...
  textSiderPrimary: '#fff',
  textsidebarSubmenu: '#fff',
  textsidebarSubmenuBackgroundColor: '#ffffff',
  // textSiderSecondary: '#797C9A',
  textSiderSecondary: '#fff',
  siderMenuOptionBackground: '#2D2560',
  siderMenuOptionColor: '#FFFFFF',
  siderMenuOptionBroder: '#9381FF',
  siderBackgroundColor: 'rgba(255, 255, 255, 0.25)',
  siderLogoTextColor: '#fff',
  subText: '#a9a9a9',
