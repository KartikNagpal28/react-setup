...
export const PersonalInfo: React.FC = () => {
  ...
  const onFinish = useCallback((values: PaymentCard) => {
    ...
    <Card>
      ...
      >
        <Row gutter={{ xs: 10, md: 15, xl: 30 }}>
          ...
          <Col span={24}>
            <BaseButtonsForm.Item>
              <BaseButtonsForm.Title>Address</BaseButtonsForm.Title>
            </BaseButtonsForm.Item>
          </Col>
          ...
          <Col span={24}>
            <BaseButtonsForm.Item>
              <BaseButtonsForm.Title>Other info</BaseButtonsForm.Title>
            </BaseButtonsForm.Item>
          </Col>
